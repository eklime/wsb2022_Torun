...
resource storageAccounts_wsbstgsadsdfresf_name_default_wsb 'Microsoft.Storage/storageAccounts/fileServices/shares@2021-06-01' = {
  parent: Microsoft_Storage_storageAccounts_fileServices_storageAccounts_wsbstgsadsdfresf_name_default
  name: 'wsb'
  properties: {
    accessTier: 'Hot'
    shareQuota: 5120
  ...
  dependsOn: [
    storageAccounts_wsbstgsadsdfresf_name_resource
  ]
}
